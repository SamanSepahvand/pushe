...
import com.samansepahvand.pushe.ui.ActivityShowNotification;
    ...
    public void getNotification(String title, String body, String type) {
        ...
        if (type != null) {
            ...
            if (tempType.equals("update")) {
                intent = new Intent(MyFirebaseMessagingService.this, ActivityUpdate.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
              //  startActivity(intent);

            } else if (tempType.equals("openitem")) {
                intent = new Intent(this, ActivityShowNotification.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
             //   startActivity(intent);
        ...
        pendingIntent = PendingIntent.getActivity(MyFirebaseMessagingService.this,
